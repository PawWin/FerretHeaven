...
function LastAdoptedFerretInfo(props) {
    return (
        <section className="container mt-3 mb-3 pt-3 pb-3">
            ...
            <p className=" mt-4 " style={{fontSize:"18px", textAlign:"left"}}>
                Poznaj fretke o imieniu Genowefa! Ta urocza fretka trafiła do naszego schroniska w poszukiwaniu nowego domu i kochającej
                rodziny. Historia tej fretki jest pełna przygód i wyzwań, ale mimo wszystko zachował on radość życia i
                otwarte serce. Genowefa została znaleziony samotny na ulicy, bez opieki i bezdomny. W naszym schronisku
                zapewniamy mu bezpieczne schronienie, regularne posiłki oraz miłość i troskę, której tak bardzo
                potrzebuje. Pomimo trudności, jakie napotkała w swoim życiu, Genowefa to zwierzę pełne energii i entuzjazmu.
                Kocha zabawę i towarzystwo ludzi, a jego ciekawość świata jest nieskończona. Teraz, kiedy jest w naszym
                schronisku, Genowefa czeka na swoją szansę na znalezienie stałego domu i kochającą rodzinę, która doceni
...
export default LastAdoptedFerretInfo;