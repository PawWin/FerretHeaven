                ...
                <div className="row">
                    <div className="col-12">
                        <div className="mb-5">
                            ...
                            <p className="text-center m-0">Nie masz jeszcze konta? <Link to="/register">Zarejestruj się</Link></p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div className="row gy-3 overflow-hidden">
                                            ...
                                            <div className="row justify-content-between">
                                                ...
                                                <div className="col-6">
                                                    <div className="text-end">
                                                        <a href="#!" className="link-secondary text-decoration-none">Zapomniałeś
                                                            hasła?</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-12">
                                            <div className="d-grid">
                                                <button className="btn btn-lg btn-dark rounded-0 fs-6" type="submit">Zaloguj
                                                    Się</button>
                                            </div>
                                        </div>
                                    </div>
